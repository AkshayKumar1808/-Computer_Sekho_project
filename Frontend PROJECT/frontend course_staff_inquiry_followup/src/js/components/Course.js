...
const Course = () => {
   ...
   const navigate= useNavigate();
    ...
    const fetchCourses = async () => {
        // const url = 'http://localhost:5120/api/pta/getallcourse/course';
    ...
    const addCourse = async (course) => {
        // const url = 'http://localhost:5120/api/pta/addcourse/course';
        const url = 'http://localhost:5210/api/pta/addcourse/course';
        try {
            await fetchData(url, {
                method: 'POST',
                headers: {
    ...
    const updateCourseStatus = async (id, isActive) => {
        ...
        // const url = `http://localhost:5120/api/pta/updatecourse/course/${id}`;
        const url = `http://localhost:5210/api/pta/updatecourse/course/${id}`;
