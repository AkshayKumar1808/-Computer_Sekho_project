...
const AdminAddEnquiry = () => {
  ...
  const fetchData = async () => {
    try {
      const courseResponse = await fetch("http://localhost:5210/api/pta/getallcourse/course"); // Update with your API endpoint
      const staffResponse = await fetch("http://localhost:5210/api/pta/getstaff"); // Update with your API endpoint
...
const handleSubmit = (e) => {
    ...
    fetch("http://localhost:5210/api/admin/Add", {
      method: "POST",
      headers: {
...
export default function AdminAddEnquiry() {
    ...
    const handleSubmit = async (e) => {
        ...
        const url = 'http://localhost:5176/api/admin/Add';
        try {
            await fetchData(url, {
                method: 'POST',
                headers: {
        ...
        <form onSubmit={handleSubmit}>
            ...
            <div>
                ...
                <input
                    type="Text"
                    name="courseName"
                    value={adminEnquiry.course.courseName ||"" }
            ...
            <div>
                ...
                <input
                    type="text"
                    name="staffname"
                    value={adminEnquiry.staff.staffname || ""}
