...
export default function Announcement() {
    ...
    const fetchAnnouncement = async () => {
        const url = 'http://localhost:5120/api/pta/allgetannoucement'; // Replace with your actual endpoint
        try {
    ...
    const addAnnouncement = async (newAnnouncement) => {
        const url = 'http://localhost:5120/api/admin/postannoucement';
    ...
    const updateAnnouncement = async (id,announcement) => {
        const url = `http://localhost:5120/api/admin/putannoucement/${id}`;
        const token = localStorage.getItem('jwt1');
        try {
            const response = await fetch(url, {
                method: 'PUT',
    ...
    const deleteAnnouncement = async (announcementId) => {
        const url = `http://localhost:5120/api/admin/delannoucement/${announcementId}`;
        const token = localStorage.getItem('jwt1');
        try {
            const response = await fetch(url, {
                method: 'DELETE',
