...
namespace ComputerSeekho.Migrations
{
    ...
    [Migration("20240816104035_Add-Migration -verbose")]
    partial class AddMigrationverbose
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ComputerSeekho.Models.PlacementMaster", b =>
                {
                    ...
                    b.Property<int?>("StudentMasterStudentId")
                        .HasColumnType("int");

                    b.HasKey("PlacementId");

                    b.HasIndex("StudentMasterStudentId");
            ...
            modelBuilder.Entity("ComputerSeekho.Models.PlacementMaster", b =>
                {
                    b.HasOne("ComputerSeekho.Models.StudentMaster", null)
                        .WithMany("PlacementMasters")
                        .HasForeignKey("StudentMasterStudentId");
                });

            modelBuilder.Entity("ComputerSeekho.Models.StudentMaster", b =>
                {
                    b.Navigation("PlacementMasters");
                });
